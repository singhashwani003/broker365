                ...
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                    <div class="property-card p-3 border border-2 rounded shadow-lg bg-light ">
                        <div class="property-item" style="width:300px;">
                            ...
                            <button class="accordion active" onclick="activehandle()" style="background-color: #07133D; color: #fff;">Budget</button>
                            ...
                            <button class="accordion active mt-3" style="background-color: #07133D; color: #fff;">No. of Bedrooms</button>
                            ...
                            <button class="accordion active mt-3">Type of property</button>
                            ...
                            <button class="accordion active mt-3">Available for</button>
                            <div class="panel px-2" style="display:block;">
                                <div class="resident mt-2">
                                    <span><i class="fas fa-plus me-2"></i></span>
                                    <span>Family</span>
                            ...
                            <button class="accordion active mt-3">Posted by</button>
                            <div class="panel px-2" style="display:block;">
                                <div class="resident mt-2">
                                    <span><i class="fas fa-plus me-2"></i></span>
                                    <span>Owner</span>
                            ...
                            <button class="accordion active mt-3">Furnishing status</button>
                            <div class="panel px-2" style="display:block;">
                                <div class="resident mt-2">
                                    <span><i class="fas fa-plus me-2"></i></span>
                            ...
                            <button class="accordion active mt-3">Localities</button>
                            ...
                            <button class="accordion active mt-3">New Projects / Societies</button>
                            ...
                            <button class="accordion active mt-3">No. of bathrooms</button>
                            <div class="panel px-2" style="display:block;">
                                <div class="resident mt-2">
                                    <span>1</span>
                                    <span><i class="fas fa-plus me-2"></i></span>
                            ...
                            <button class="accordion active mt-3">Amenities</button>
                            <div class="panel px-2" style="display:block;">
                                <div class="resident mt-2">
                                    <span><i class="fas fa-plus me-2"></i></span>
                                    <span>Parking</span>
                            ...
                            <button class="accordion active mt-3">Area</button>
                            <div class="panel px-2" style="display:block;">
                            <form action="/action_page.php" class="mt-3">
                                    <div class="d-flex justify-content-between align-items-center mb-2 label-btn">
                            ...
                            <button class="accordion active mt-3">Available from</button>
                            <div class="panel px-2" style="display:block;">
                                <div class="resident mt-2">
                                    <span><i class="fas fa-plus me-2"></i></span>
                                    <span>Residential Apartment</span>
                            ...
                            <button class="accordion active mt-3">Age of Property</button>
                            <div class="panel px-2" style="display:block;">
                                <div class="resident mt-2">
                        ...
                        <div class="row border border-0 rounded shadow-lg buy-height property-blog">
                            ...
                            <div class="col-6 my-3 p-0 bg-light">
                                <div class="blog-2">
                                    ...
                                    <button class="accordion active px-4 py-3">This luxurious builder floor is strategically located at indirapuram. The apart</button>
                                    <div class="panel px-4" style="display:block;">
